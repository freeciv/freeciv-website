...
$(function() {
  ...
  if (window.ui.os=="Windows") {
    $("#download_button").attr("href", "http://prdownloads.sourceforge.net/freeciv/Freeciv-2.5.2-win32-gtk2-setup.exe?download");
  } else if (window.ui.os=="Linux") {
    $("#download_button").attr("href", "http://prdownloads.sourceforge.net/freeciv/freeciv-2.5.2.tar.bz2?download");
