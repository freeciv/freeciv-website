...
$(function() {
  ...
  if (window.ui.os=="Windows") {
    $("#download_button").attr("href", "https://prdownloads.sourceforge.net/freeciv/Freeciv-3.0.9-msys2-win64-gtk3.22-setup.exe?download");
  } else if (window.ui.os=="Linux") {
    $("#download_button").attr("href", "https://prdownloads.sourceforge.net/freeciv/freeciv-3.0.9.tar.xz?download");
